...
class HuBMAPDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return img2tensor((img/255.0 - mean)/std), img2tensor(mask), torch.from_numpy(np.array(cls_index))
...
class UneXt50(nn.Module):
    def __init__(self, stride=1, **kwargs):
        ...
        self.encoder_cls_fpn = FPN([2048, 1024 ,512],[256]*4)
        self.pool_layer = nn.MaxPool2d(64, stride=2)
    ...
    def forward(self, x):
        ...
        cls_feature = self.pool_layer(self.encoder_cls_fpn([enc4, enc3, enc2], enc1))
